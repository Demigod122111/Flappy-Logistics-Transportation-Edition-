...
# Function to draw
def draw_floor():
    screen.blit(floor_img, (floor_x, 530))
    screen.blit(floor_img, (floor_x + 448, 530))
...
pygame.display.set_caption("Logistics Transportation")
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:  # Key pressed event
            ...
            if event.key == pygame.K_q:
                webbrowser.open("https://docs.google.com/presentation/d/1gNExji-p1jaEY0hlcO7pAy_L3WiZ6NTxMq_DB9sqPNI/edit?usp=sharing")
